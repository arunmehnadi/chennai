    ...
    <div className="relative mt-16 bg-gray-800">
      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          ...
          <div className="md:max-w-md lg:col-span-2 text-white">
            ...
            <div className="mt-4 lg:max-w-sm">
              <p className="text-sm text-gray-300">
                We specialize in bridal mehandi art, making your special day even more memorable with beautiful designs.
              </p>
              <p className="mt-4 text-sm text-gray-300">
                Our artists are highly skilled, providing the best mehandi for your wedding, parties, and other events.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li>
                  <p className="text-gray-300">Call Us: 7736789140</p>
                </li>
                <li>
                  <p className="text-gray-300">Email: milanmehanditattos@gmail.com</p>
                </li>
                <li>
            ...
            <div>
              ...
              <div className="flex gap-4 mt-2">
                ...
                {/* <a
                  href="https://youtube.com/@akashnayak000"
                  target="_blank"
                  className="text-gray-300 hover:text-yellow-400"
                >
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-700 sm:flex-row">
          <p className="text-sm text-gray-300">
            &copy; {new Date().getFullYear()} Arun Mehandi Artist. All rights reserved.
          </p>
